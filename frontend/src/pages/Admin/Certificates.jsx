...
const Certificates = () => {
  ...
  const fetchCertificates = async () => {
    setIsLoading(true);
    try {
      // Base URL for fetching certificates
    ...
    try {
      ...
      setVerificationResult({
        ...
        details: {
          ...
          hashMatch: response.data.isValid,
          networkConsensus: response.data.isValid ? "Valid" : "Invalid",
          issuer: "Farmers Connect Admin",
          expiryDate: response.data.expiryDate,
          farmerName: response.data.farmerName,
          farmerId: response.data.farmerId,
          aadhaarHash: response.data.aadhaarHash,
              ...
              <div className="mb-6 p-6 bg-gradient-to-br from-[#2d4f47] to-[#1e3831] rounded-lg border border-teal-500/10">
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                  <div>
                    ...
                    <p className="text-white">{selectedCertificate.farmerId}</p>
                  </div>
                  <div>
                  ...
                  <div className="col-span-2">
                    ...
                    <p className="text-white flex items-center">
                      {selectedCertificate.blockchainTxId}
                      <a 
                          ...
                          <div className="mt-4 text-sm">
                            <div className="grid grid-cols-2 gap-2">
                              <div>
                                ...
                                <p className="text-gray-300">{verificationResult.details.txId}</p>
                              </div>
                              <div>
                              ...
                              {verificationResult.details.aadhaarHash && (
                                <div>
                                  ...
                                  <p className="text-gray-300">{verificationResult.details.aadhaarHash}</p>
                                </div>
                              )}
                            </div>
                          </div>
